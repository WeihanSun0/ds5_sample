...
""" Convert file names saved by DSViewer to input file name of sample code
    File name save by DSViewer:
        -<timestamp>_<file type>.<ext name>
